	...
	<body class="body" bgcolor="#E3E3E3" >
		<div class="header">
			...
			<div class="body1">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="LoginServlet?flag=<%=str%>&id=<%=e.getEid() %>">部门信息</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div class="body2">
			<div class="bodyleft">
				...
				<table border="1" width="700px" align="center" style="border-collapse: collapse">
					...
					<%
						...
						int pageNum = 10;
						int currPage;
						String url="resource_jsp/bossmanager.jsp";
			...
			<div class="bodyright">
				...
				<div align="center">
					<form action="resource_jsp/upload.jsp?eid=<%=e.getEid()%>" method="post">
				...
				<div align="center">
					<form action="servlet/DeptServlet?position=<%=e.getPosition() %>&dept=<%=e.getDepartment() %>" method="post">
						<input type="submit" name="button" value="资源管理">
					</form>
				</div>
			</div>
		</div>
